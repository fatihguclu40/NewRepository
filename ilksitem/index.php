...
<aside>
      <div class="wrapper">
        ...
        <?php $sayfasor=mysql_query("select * from sayfalar where sayfa_anasayfa='1' order by sayfa_id DESC");
         while ($sayfacek=mysql_fetch_assoc($sayfasor)){ ?>


        <div style="padding-top: 10px; padding-left: 10px" class="column-2">
          <div class="box">
