...
<head>
  ...
  <script src="js/benimdosyam.js"></script>
...
<div style="float: right;">
    <a href="login.php"><input style="width: 120px; margin-top: 20px; margin-right: 10px;" class="btn btn-danger " type="button" name="Giriş" value="Kullanıcı Girişi"></a>
  </div>
      ...
      <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
        ...
        <div style="background-color: white; margin-top: 120px; opacity: 0.8;" class="panel-body">
          <form action="baglanti/islem.php" method="POST">
            <hr />
            <center><h3><b>Yönetim Paneli</b></h3></center>
            ...
            <?php if ($_GET['durum']=="no") {
                echo "Kullanıcı Bulunamadı yada Yönetici Değilsiniz.";
              }
            ...
            <input style="width: 100%" class="btn btn-primary" type="submit" name="login_yonetici" value="Giriş Yap">
